...
osThreadId ReadDigitalHandle;
osThreadId ReadAnalogHandle;
osThreadId ReadCOMHandle;
...
/* USER CODE BEGIN Header_StartReadDigital */
/**
  * @brief  Function implementing the ReadDigital thread.
