...
osThreadId adjustDisplayHandle;
osThreadId readInputsHandle;
/* USER CODE BEGIN PV */
char commMethod = 0;
uint8_t controllerBat = 0;
/* USER CODE END PV */
...
int main(void)
{
  ...
  MX_TIM7_Init();
  /* USER CODE BEGIN 2 */
//  if(HAL_GPIO_ReadPin(BOOT1_GPIO_Port, BOOT1_Pin) == SET){
//	  commMethod = 'n';
//  }
//  else{
//	  commMethod = 'b';
...
/* USER CODE BEGIN Header_StartAdjustDisplay */
/**
* @brief Function implementing the adjustDisplay thread.
* @param argument: Not used
* @retval None
*/
...
//	ST7735_FillScreen(ST7735_BLACK);
  ...
  /* USER CODE END StartAdjustDisplay */
}

/* USER CODE BEGIN Header_StartReadInputs */
/**
